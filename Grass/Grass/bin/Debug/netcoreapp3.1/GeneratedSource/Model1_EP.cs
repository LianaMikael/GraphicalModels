...
namespace Models
{
	...
	public partial class Model1_EP : IGeneratedAlgorithm
	{
		...
		/// <summary>True if Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue has executed. Set this to false to force re-execution of Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue</summary>
		public bool Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue_isDone;
		...
		public bool cloudyEqTrue
		{
			...
			set {
				if (this.CloudyEqTrue!=value) {
					...
					this.Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue_isDone = false;
				}
			}
		}
		...
		/// <summary>Computations that depend on the observed value of cloudyEqTrue and rainEqTrue and wetGrassEqTrue</summary>
		private void Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue()
		{
			if (this.Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue_isDone) {
				return ;
			}
			...
			this.Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue_isDone = true;
		}
		...
		private void Execute(int numberOfIterations, bool initialise)
		{
			...
			this.Changed_cloudyEqTrue_rainEqTrue_wetGrassEqTrue();
